...
export default function Home() {
  ...
  const query = `
  *[_type == "page" && pageName == "Resources & Support"][0]{
    _id,
    pageName,
...
<section className="bg-fixnix-lightpurple py-7 pb-24 text-left-mobile">
  ...
  <div className="container">
    <div className="text-left">
      ...
      <p className="relative text-left-mobile inline-block text-[24px] leading-[16px] text-white font-bold  uppercase z-[1]">
        {purpleContent?.title}
        <span className="absolute top-[8px] left-[-56px] translate-y-[-50%] w-[40px] h-[2px] bg-white"></span>
      </p>

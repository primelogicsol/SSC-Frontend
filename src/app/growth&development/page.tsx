...
export default function Home() {
  ...
  const query = `
  *[_type == "page" && pageName == "Growth & Development"][0]{
    _id,
    pageName,
              ...
              <div className="w-full lg:w-7/12 xl:w-1/2 py-8 lg:py-5 lg:pl-12 xl:pl-24">
                <div className="relative">
                  <div className="text-left mb-8">
                    ...
                    <h2 className="text-[10px] sm:text-xl md:text-2xl font-semibold mt-3 mb-3 leading-snug sm:leading-tight">
                    ...
                    <h2 className="text-xl sm:text-xl md:text-xl font-semibold mt-3 -mb-16  leading-snug sm:leading-tight">

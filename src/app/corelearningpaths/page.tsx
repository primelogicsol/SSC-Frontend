...
export default function Home() {
  ...
  const [beginnerChecklistData ,setBeginnerChecklistData] = useState<any>()
  ...
  const query = `
  *[_type == "page" && pageName == "Core Learning Paths"][0]{
    _id,
    pageName,
    ...
    "beginnerChecklistData" : contentSections[type == "beginnerChecklist"][0].beginnerChecklist,
  }
`;
...
useEffect(() => {
  ...
  client.fetch(query)
    .then((data) => {setHeroData(data.heroSection);
                    ...
                    setBeginnerChecklistData(data.beginnerChecklistData)
                  }
    )
...
{complexContentData.length > 0 ? (
  ...
  <div></div>
      ...
      <div className="relative block">
        ...
        <div className="container">
          <div className="row">
            {whiteChart?.subChart.subTitle.map((item : any , idx : number)=>{
              return (
                <div key={idx}
                className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp"
                data-wow-delay="100ms"
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="absolute top-0 right-0 bg-fixnix-lightpurple text-white py-1 px-3 rounded-tr-3xl rounded-bl-xl text-sm font-medium z-20">
            ...
            <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-white">{beginnerChecklistData?.heading}</h1>
            <p className="text-purple-100 mt-1 text-sm sm:text-base">{beginnerChecklistData?.subheading}</p>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-between mb-2 gap-2">
            ...
            <p className="mt-2 text-center mx-[14%]">{beginnerChecklistData?.bottomNote}.</p>

...
const components: PortableTextComponents = {
  block: {
    ...
    normal: ({ children }) => <p className="text-base text-gray-800 mb-2">{children}</p>,
  },
}
...
export default function Home() {
  ...
  const [leftsideImageContent3 , setLeftSideImageContent3] = useState<any>()
  ...
  const [teachingAssessmentForm , seTteachingAssessmentForm] = useState<any>()

  const query = `
  *[_type == "page" && pageName == "Leadership & Teaching"][0]{
    _id,
    pageName,
    ...
    "leftSImageContent3" :  contentSections[type == "goalSection"][2].goalSection,
    ...
    "teachingAssessmentForm" : contentSections[type == "teachingAssessment"][0].teachingAssessment,
  }
`;
...
useEffect(() => {
              ...
              <div className="w-full lg:w-7/12 xl:w-1/2 py-8 lg:py-5 lg:pl-12 xl:pl-24">
                <div className="relative">
                  <div className="text-left mb-8">
                    ...
                    <PortableText value={leftsideImageContent?.description} components={components} />
                    </div>
  ...
  {complexContentData.length > 0 ? (
    complexContentData.map((content, idx) => (
      <section key={idx} className="relative block">
        <div className="container mx-auto px-4">
          ...
          <div className="relative  py-[20px] pt-10">
            <div className="flex flex-col  bg-gray-100 p-0 pb-[52px] mb-[20px] relative z-10 rounded-3xl">
              <div className="absolute  top-0 right-0 bg-fixnix-lightpurple text-white py-1 px-3 rounded-tr-3xl rounded-bl-xl text-sm font-medium z-20">
                {content.label}
              </div>
              ...
              {Array.isArray(content.contentSections) &&
                content.contentSections.map((section, sectionIdx) => (
                  <div key={sectionIdx} className="  px-10 relative">
                    <div className="mb-[24px]">
                      <h4 className="text-[30px] font-semibold leading-[40px] mb-[14px]">
                      ...
                      section.subSections.length > 0 && (
                        <ul className="space-y-[17px] pb-[17px]">
                          {section.subSections.map((sub, subIdx) => (
                            ...
                            >
                              <div>
                                <h5 className="text-[18px] font-semibold leading-[34px] text-fixnix-lightpurple mb-[14px]">
                                  {sub.subHeading}
                                </h5>
    ...
    <div></div>
        ...
        <div className="relative block max-w-[1180px] px-4 mx-auto  py-[120px] pt-10 ">
                    ...
                    <div className="relative block bg-[var(--fixnix-primary)] py-6  mt-8 mb-6 before:absolute before:left-0 before:top-0 before:bottom-0 before:w-1.5 before:bg-[var(--fixnix-lightpuple)] before:rounded-md before:content-['']">
                      
                      <div className="relative inline-block text-xl leading-7 text-[var(--fixnix-darkpurple)] mt-4 ml-14 ">
                      <PortableText value={simpleContent?.description} components={componentsForSimpleContent} />
                      </div>
                      {/* <p className="relative inline-block text-xl leading-7 text-[var(--fixnix-darkpurple)] mt-4 ml-14 before:content-[''] before:absolute before:h-0.5 before:w-10 before:top-3.5 before:left-[-54px] before:bg-[var(--fixnix-lightpuple)]">
                      "The function of the murshid is to point the way to the summit, but the spiritual climbing (suluk) must be done by the murid." — Hazrat Inayat Khan
                      </p>
              ...
              <div className="w-full lg:w-7/12 xl:w-1/2 py-8 lg:py-5 lg:pl-12 xl:pl-24">
                <div className="relative">
                  <div className="text-left mb-8">
                    ...
                    <h2 style={{ whiteSpace: 'pre-line' }} className="text-2xl sm:text-3xl md:text-4xl font-semibold mt-4 mb-6 leading-snug sm:leading-tight">
                    {leftsideImageContent2?.heading.replace(/\\n/g, '\n')}
                    </h2>
                    <h2 className="text-[10px] sm:text-[15px] md:text-xl font-bold mt-3 mb-3 leading-snug sm:leading-tight">
                    {leftsideImageContent2?.subheading}
                    </h2>
                    <div className="text-base sm:text-lg text-gray-700 space-y-4">
                    <PortableText value={leftsideImageContent2?.description} components={components} />
                    </div>
                    <h2 className="text-xl sm:text-xl md:text-xl font-semibold mt-3 -mb-6  leading-snug sm:leading-tight">
  ...
  leftsideImageContent2.points.map((point: any, idx: number) => (
    <li
      key={idx}
      className="relative flex items-center p-4 py-6 md:py-8 bg-white rounded-lg shadow-md transition-all duration-500 hover:-translate-y-[10px] group "
    >
      <div className="ml-6 sm:ml-6">
        <h5 className="text-lg sm:text-xl md:text-[21px] font-semibold text-white transition-colors duration-500">
          {point.title}
  ...
  <div></div> 
        ...
        <div style={{ background : leftsideImageContent3?.bgImage?.asset ? `url(${urlFor(leftsideImageContent3?.bgImage).url()})` : '',
                   }} className="relative block py-12 lg:py-28 bg-cover bg-center bg-no-repeat">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap items-center">
              {/* Left Section */}
              <div className="w-full lg:w-5/12 xl:w-1/2 pt-8 lg:pt-14">
                <div className="relative">
                  <div className="rounded-lg overflow-hidden relative group">
                  {leftsideImageContent3?.image?.asset && (
                     <Image
                     src={urlFor(leftsideImageContent3.image).url()}
                     alt="Core services"
                     layout="responsive"
                     width={500}
                     height={400}
              ...
              <div className="w-full lg:w-7/12 xl:w-1/2 py-8 lg:py-5 lg:pl-12 xl:pl-24">
                <div className="relative">
                  <div className="text-left mb-8">
                    <span className="relative inline-block text-sm sm:text-base md:text-lg text-fixnix-lightpurple font-semibold uppercase z-[1]">
                    {leftsideImageContent3?.intro} 
                      <span className="absolute top-[10px] left-[-50px] w-[40px] sm:w-[45px] h-[2px] bg-fixnix-lightpurple"></span>
                    </span>
                    <h2 style={{ whiteSpace: 'pre-line' }} className="text-2xl sm:text-3xl md:text-4xl font-semibold mt-4 mb-6 leading-snug sm:leading-tight">
                    {leftsideImageContent3?.heading.replace(/\\n/g, '\n')}
                    </h2>
                    <h2 className="text-[10px] sm:text-[15px] md:text-xl font-bold mt-3 mb-3 leading-snug sm:leading-tight">
                    {leftsideImageContent3?.subheading}
                    </h2>
                    <div className="text-xl sm:text-lg text-gray-700 space-y-4">
                    <PortableText value={leftsideImageContent3?.description} components={components} />
                    </div>
                    <h2 className="text-xl sm:text-xl md:text-xl font-semibold mt-3 -mb-6  leading-snug sm:leading-tight">
                    {leftsideImageContent3?.pointsHeading}
                    </h2>
                  </div>
                  <ul className="space-y-6 sm:space-y-8 lg:space-y-10">
                  {leftsideImageContent3?.points && leftsideImageContent3.points.length > 0 ? (
  leftsideImageContent3.points.map((point: any, idx: number) => (
    <li
      key={idx}
      className="relative flex items-center p-4 py-6 md:py-8 bg-white rounded-lg shadow-md transition-all duration-500 hover:-translate-y-[10px] group "
    >
  ...
  <div></div> 
        ...
        <div id="assessment-form" className=" max-w-4xl mx-auto bg-white rounded-xl shadow-md mt-8 overflow-hidden">
        <h2 className="text-lg sm:text-3xl md:text-4xl lg:text-lg 2xl:text-lg font-semibold mt-4 mb-6 px-6  leading-snug sm:leading-tight">
                {teachingAssessmentForm?.title}
                </h2>
      <div className="bg-gradient-to-r from-fixnix-lightpurple to-fixnix-darkpurple py-6 px-6 md:px-8">
        <h1 className="text-2xl md:text-3xl font-bold text-white">{teachingAssessmentForm?.heading}</h1>
        <p className="text-indigo-100 mt-2">{teachingAssessmentForm?.subHeading}</p>
      </div>
      ...
      <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
        ...
        <PortableText value={teachingAssessmentForm?.note} />        </div>
      </div>
    </div>

    <section className="bg-fixnix-lightpurple mt-7 py-7 pb-24 text-left-mobile">

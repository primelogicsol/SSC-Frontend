...
export default function Home() {
  ...
  const query = `
  *[_type == "page" && pageName == "Begin Your Journey"][0]{
    _id,
    pageName,
...
useEffect(() => {
              ...
              <div className="w-full lg:w-7/12 xl:w-1/2 py-8 lg:py-5 lg:pl-12 xl:pl-24">
                <div className="relative">
                  <div className="text-left mb-8">
                    ...
                    <h2 className="text-3xl sm:text-xl md:text-4xl font-semibold mt-3 mb-3 leading-snug sm:leading-tight">
                    {leftsideImageContent?.heading}
                    </h2>
                    <h2 className="text-2xl sm:text-[22px] md:text-[26px] font-bold mt-4 mb-6 leading-snug sm:leading-tight">
  ...
  leftsideImageContent.points.map((point: any, idx: number) => (
    <li key={idx} className="relative flex items-center p-4 py-6 md:py-8 bg-white rounded-lg shadow-md transition-all duration-500 hover:-translate-y-[10px] group ">
    <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-fixnix-lightpurple text-white text-lg sm:text-xl rounded-full transition-colors duration-500 ">
      <span className="icon-checked"></span>
    </div>
    <div className="ml-6 sm:ml-6">

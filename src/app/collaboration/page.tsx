...
export default function Home() {
  ...
  const query = `
  *[_type == "page" && pageName == "Collaborations"][0]{
    _id,
    pageName,
    ...
    "whiteContentChart" : contentSections[type == "whiteContentChart"][0].whiteContentChart,
...
`;
  ...
  useEffect(() => {
    ...
    client.fetch(query)
      .then((data) => {setHeroData(data.heroSection);
                      ...
                      setWhiteChart(data.whiteContentChart)
  ...
  console.log("rs image",leftsideImageContent?.image)
    ...
    <>
      <Layout headerStyle={2} footerStyle={1}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          {whiteChart?.subChart.map((item : any , idx : number)=>{
            return (
              <div key={idx} className="wow fadeInUp" data-wow-delay="100ms">
            <div className="bg-white p-6 rounded-lg shadow-lg transform transition-transform hover:scale-105 hover:shadow-2xl">
              <div className="flex flex-col items-center">
                <div className="bg-fixnix-lightpurple p-4 rounded-full mb-4 transition-transform transform hover:scale-110">
                  <span className="icon-phone text-white text-2xl"></span>
                </div>
                <h3 className="text-2xl font-semibold text-center mb-4">{item.subHeading}</h3>
                <p className="text-left text-gray-700">
                  {item.subDescription}
                </p>
              </div>
        ...
        <div className="absolute top-[10px] left-0 services-one-shape-1">
          ...
          <div className="container">
            ...
            <div className="row flex flex-wrap">
              ...
              {purpleChart?.subChart.map((item : any , idx : number)=>{
                return(
                  <div key={idx}
                className="col-xl-4 col-lg-4 wow fadeInUp"
                data-wow-delay="100ms"

...
import {DigitalBook} from "../../types/giftShopProductType"
...
const DigitalBook : React.FC<Props> = ({ data  }) => {
      ...
      <div className="container mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">By {data.author}</p>
          ...
          <div className="py-6">
            {activeTab === "description" && (
              <div className="prose max-w-none">
                <h2 className="text-2xl font-bold mb-4">{data.descriptionBlock?.heading}</h2>
                <p className="text-gray-600 mb-6">{data.descriptionBlock?.note}</p>
                {data.descriptionBlock?.detail?.map((item , idx)=>{
                    return(
            ...
            {activeTab === "terms" && (
              <div className="prose max-w-none">
                <h2 className="text-2xl font-bold mb-4">{data.termsSection?.heading}</h2>
                <div className="space-y-4">
                  <p className="text-gray-600">
                  {data.termsSection?.note}
                  </p>
                  <ul className="list-disc pl-5 text-gray-600">
                    <li>
                        <PortableText components={components} value={data.termsSection?.description} />
                    </li>

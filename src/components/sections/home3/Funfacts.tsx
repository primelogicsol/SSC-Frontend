    ...
    <>
      ...
      <section className="relative  py-24 bg-fixnix-lightpurple z-10">
        ...
        <div className="container mx-auto px-4">
          <div className="w-full">
            <h2 className=" font-bold text-3xl md:text-4xl lg:text-5xl text-white text-center">
              {data?.staticChart.mainTitle}
            </h2>
            <h4 className=" font-medium text-xl md:text-2xl text-white text-center pt-1 pb-6">
            {data?.staticChart.subtitle}
            </h4>
            <div className="flex flex-wrap items-center">
              <div className="w-full sm:w-1/2 md:w-1/4 text-center mb-8 relative">
                <div className="absolute top-5 right-0 bottom-0 w-px bg-white hidden md:block"></div>
                <div className="flex justify-center items-center">
                  <span className="text-4xl md:text-5xl lg:text-6xl font-semibold text-white font-secondary">
                    <CounterUp end={Number(data?.staticChart.stats[0].value)} />
                  </span>
                  <span className="text-4xl md:text-5xl lg:text-6xl font-semibold text-white font-secondary relative">+</span>
                </div>
                <p className="text-xl md:text-2xl font-semibold text-white mt-2">{data?.staticChart.stats[0].title}</p>
              </div>
              ...
              <div className="w-full sm:w-1/2 md:w-1/4 text-center mb-8 relative">
                ...
                <div className="flex justify-center items-center">
                  <span className="text-4xl md:text-5xl lg:text-6xl font-semibold text-white font-secondary">
                    <CounterUp end={Number(data?.staticChart.stats[1].value)} />
                  </span>
                  <span className="text-4xl md:text-5xl lg:text-6xl font-semibold text-white font-secondary relative">+</span>
                </div>
                <p className="text-xl md:text-2xl font-semibold text-white mt-2">{data?.staticChart.stats[1].title}</p>
              </div>
              ...
              <div className="w-full sm:w-1/2 md:w-1/4 text-center mb-8 relative">
                ...
                <div className="flex justify-center items-center">
                  <span className="text-4xl md:text-5xl lg:text-6xl font-semibold text-white font-secondary">
                    <CounterUp end={Number(data?.staticChart.stats[2].value)} />
                  </span>
                  <span className="text-4xl md:text-5xl lg:text-6xl font-semibold text-white font-secondary relative">+</span>
                </div>
                <p className="text-xl md:text-2xl font-semibold text-white mt-2">{data?.staticChart.stats[2].title}</p>
              </div>
              
              <div className="w-full sm:w-1/2 md:w-1/4 text-center mb-8 relative">
                <div className="flex justify-center items-center">
                  <span className="text-4xl md:text-5xl lg:text-6xl font-semibold text-white font-secondary">
                    <CounterUp end={Number(data?.staticChart.stats[3].value)} />
                  </span>
                  <span className="text-4xl md:text-5xl lg:text-6xl font-semibold text-white font-secondary relative">+</span>
                </div>
                <p className="text-xl md:text-2xl font-semibold text-white mt-2">{data?.staticChart.stats[3].title}</p>
              </div>
            </div>
          </div>
        </div>

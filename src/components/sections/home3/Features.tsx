      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature: Feature, index: number) => (
            <div
              key={index}
              className="wow fadeInUp transition-transform duration-500 hover:-translate-y-2 h-full"
            >
              <div className="flex flex-col justify-between text-center p-10 bg-white shadow-lg rounded-xl h-full">
